...
Aether Gen 2 includes a hyper-optimized CLI for direct training control.
...
## 📁 Project Structure
*   `rust_core/`: Physics engine and orchestrator (SIMD-optimized).
*   `py_agents/`: PyTorch Hivemind implementation.
*   `schema/`: FlatBuffers definitions for zero-copy IPC.
